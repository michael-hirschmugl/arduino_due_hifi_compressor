/*
  ...
  Communication with the WM8731 Codec.
...
*/
uint8_t WM8731_COMClass::set_wm8731(uint8_t byte1, uint8_t byte2)
{
  SAM3X8E_TWI.send_two_bytes(TWI1_MMR_DADR, byte1, byte2);
  return 0;
}
...
/*
  ...
  returns 0 if OK
*/
//uint8_t WM8731_COMClass::send_two_bytes_to_wm8731(uint8_t byte1, uint8_t byte2)
//{
//    uint16_t i = 0;
//    TWI1_THR = byte1;
//
...
// Create object
WM8731_COMClass WM8731_COM = WM8731_COMClass();